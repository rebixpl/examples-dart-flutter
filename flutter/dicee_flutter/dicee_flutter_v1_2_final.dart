  ...
  void changeDiceFace() {
    setState(() {
      leftDiceNumber = Random().nextInt(6) +
          1; // Generating a random int between 1 and 6, using dart:math library
        ...
        child: Row(
          children: <Widget>[
            Expanded(
              ...
              child: FlatButton(
                // A flat button is a text label displayed on a (zero elevation) Material widget that reacts to touches by filling with color. It has DEFAULT PADDING: left-16.0px, right-16.0px
                onPressed: () {
                  changeDiceFace();
                },
